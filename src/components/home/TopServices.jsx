            ...
            <div className='grid lg:md:grid-cols-3 grid-cols-2 gap-4 mt-10'>
                {
                    services.map((service) => {
                        return (
                            <div key={service.id} className="bg-[#fff] p-4 text-center rounded-md cursor-pointer hover:scale-105 transform transition-transform ease-in-out duration-200 hover:animate-bounce">
